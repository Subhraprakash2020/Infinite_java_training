...
CREATE TABLE `insurance_plans` (
  ...
  `Insurance_id` varchar(5) DEFAULT NULL,
  `Premium_Amount` decimal(10,2) DEFAULT NULL,
  `Coverage_Amount` decimal(10,2) DEFAULT NULL,
  `Benefits` varchar(369) DEFAULT NULL,
  PRIMARY KEY (`Plan_id`),
  KEY `Insurance_id` (`Insurance_id`),
  CONSTRAINT `insurance_plans_ibfk_1` FOREIGN KEY (`Insurance_id`) REFERENCES `insurance_details` (`Insurance_id`)
