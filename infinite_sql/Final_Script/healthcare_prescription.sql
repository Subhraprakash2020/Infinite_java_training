...
CREATE TABLE `prescription` (
  ...
  KEY `UHID` (`UHID`),
  CONSTRAINT `prescription_ibfk_1` FOREIGN KEY (`providerid`) REFERENCES `provider_details` (`providerid`),
  CONSTRAINT `prescription_ibfk_2` FOREIGN KEY (`UHID`) REFERENCES `patient_enrollment` (`UHID`)
