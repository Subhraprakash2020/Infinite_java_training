...
CREATE TABLE `patient_appointment` (
  ...
  KEY `UHID` (`UHID`),
  CONSTRAINT `patient_appointment_ibfk_1` FOREIGN KEY (`providerid`) REFERENCES `provider_details` (`providerid`),
  CONSTRAINT `patient_appointment_ibfk_2` FOREIGN KEY (`UHID`) REFERENCES `patient_enrollment` (`UHID`)
...
-- Dump completed on 2023-11-02 17:25:01
